          ...
          {selectedRun ? (
            <div className="bg-[#161b22] border border-[#30363d] rounded-lg p-5 space-y-5 h-full flex flex-col justify-between">
              <div className="space-y-4">
                ...
                {/* Score Dashboard */}
                {(() => {
                  const isAzure = selectedRun?.extraction_engine === 'azure_document_intelligence';
                  return (
                    <>
                      <div className="grid grid-cols-2 gap-3">
                        <div className="bg-[#0d1117] p-2.5 rounded border border-[#30363d] text-center">
                          ...
                          <strong className="text-sm font-mono text-white">
                            {!isAzure && (selectedRun.selected_table_available === false || selectedRun.status === 'failed') || selectedRun.confidence === null || selectedRun.confidence === undefined
                              ? '0.0%'
                      ...
                      <div className={`p-3 rounded border text-xs ${
                        ...
                        <p className="text-[11px] text-gray-400 font-sans leading-relaxed">
                          {selectedRun.status === 'safe_for_erp'
                            ...
                            : selectedRun.status === 'needs_review'
                              ? (isAzure ? 'Manual review requested due to lower confidence or missing totals.' : `This run is flagged because of missing fields: [${selectedRun.missing_fields.join(', ')}].`)
                      ...
                      <div className="space-y-2 text-xs font-mono">
                        {isAzure ? (
                          <div className="flex justify-between">
                            ...
                            <span className="text-[#00f0ff] font-semibold">Azure DI</span>
                          </div>
                        ) : (
                          <>
                            <div className="flex justify-between">
